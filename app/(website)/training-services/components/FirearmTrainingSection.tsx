        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="lg:pr-8 lg:pt-4">
              ...
              <h1 className="bold-40 lg:bold-40 text-blue-100 mb-4">Private Use</h1>

              <p className="regular-16 text-gray-30 xl:max-w-[520px]">
              Handle and use of a firearm for use in self defence, Hunting and sport shooting.
            ...
            <div className="lg:pr-8 lg:pt-4">
              ...
              <h1 className="bold-40 lg:bold-40 text-blue-100 mb-4">Business Use</h1>
              <p className="regular-16 text-gray-30 xl:max-w-[520px]">
