...
import { LockClosedIcon, ServerIcon, CloudArrowUpIcon } from '@heroicons/react/20/solid';
...
const tabs = [
  ...
  },
  {
    ...
    content: (
      <FirearmTrainingSection/>
    ),
  },
  {
    name: 'One-on-one Fire-arm Training',
    content: (
     <OneOnOneTrainingSection/>
    ),
  },
  {
  ...
  return (
    <>
      ...
      <div className="overflow-hidden text-blue-100  bg-white max-container padding-container">
        <p>Our training programs prepare individuals for careers in South African Security Laws and strategy, teaching critical skills and resulting in confident graduates ready to excel as elite officers. Our experienced instructors and state-of-the-art facilities ensure that you receive the highest quality instruction. Whether you are a beginner looking to learn the basics or an experienced individual looking to improve your skills, we have a program that is right for you.</p>
