        ...
        <section className="bg-white shadow-lg rounded-lg w-full">
            <div className="py-16 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" className="space-y-8">
                    <div>
                        <label className="block mb-2 text-sm font-medium text-blue-100">First Name & Last name</label>
                        <input type="text" id="email" className="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-primary-500 block w-full p-2.5   dark:placeholder-gray-400 dark:text-white  dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@muposecurity.com" required/>
                    </div>
                    <div>
