    ...
    <footer className="flexCenter">
      <div className="padding-container max-container flex pt-10 w-full flex-col gap-14">
        <div className="flex flex-col items-start justify-center gap-[10%] md:flex-row">
          ...
          <div className='flex flex-wrap gap-10 text-blue-100 sm:justify-between md:flex-1'>
        ...
        <p className="regular-14 w-full text-center text-gray-30">2024 Mupo Security | All rights reserved</p>
      </div>
    </footer>
  )
}
